...
<body>
    ...
    <div class="container mt-3"> <!-- Añadimos margen superior -->
        ...
        <a href="{{ route('municipios.create') }}" class="btn btn-success mb-3">Agregar</a> <!-- Añadimos margen inferior -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form
                            action="{{ route('municipios.destroy',['municipio' => $municipio->muni_codi]) }}"
